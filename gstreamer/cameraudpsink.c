 ...
 *   queue ! x264enc ! h264parse ! rtph264pay config-interval=1 !
 *   udpsink host=192.168.4.181 port=5001
 *
 *   export GST_DEBUG="*:6"
 *
...
int main()
{
    ...
    if(!pipeline || !v4l2src || !capsfilter || !queue || !x264enc
